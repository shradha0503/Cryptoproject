...
export const Footer = () => {
  const handleLinkClick = (section: string) => {
    toast.info(`${section} page coming soon!`, {
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              The fastest and most secure way to swap cryptocurrencies. Built for the future of finance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <button onClick={() => handleLinkClick("Features")} className="hover:text-primary transition-colors">
                  Features
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick("Pricing")} className="hover:text-primary transition-colors">
                  Pricing
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick("Supported Tokens")} className="hover:text-primary transition-colors">
                  Supported Tokens
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick("API Documentation")} className="hover:text-primary transition-colors">
                  API Documentation
                </button>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <button onClick={() => handleLinkClick("About Us")} className="hover:text-primary transition-colors">
                  About Us
                </button>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <button onClick={() => handleLinkClick("Cookie Policy")} className="hover:text-primary transition-colors">
                  Cookie Policy
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick("Disclaimer")} className="hover:text-primary transition-colors">
                  Disclaimer
                </button>
              </li>
            </ul>
